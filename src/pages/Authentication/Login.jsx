        ...
        <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            ...
            <form onSubmit={handleSignIn}>
                ...
                <div className="flex justify-end mt-6">
                    <input type="submit" value="Sign In" className="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600" />
                </div>
            </form>
        </section>)
};
